Shader "examples/week 9/TrackCar"
{
    Properties 
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                normal = (sin(normal *  _Time.y * 0.16));
                ...
                float3 sviewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld);
                float3 halfDirection = normalize(lightDirection + sviewDirection);

                float specularFalloff = max(0, dot(normal, halfDirection));
                specularFalloff = pow(specularFalloff, _sgloss * 1 + 1) * _sgloss;
                ...
                color = (indirectSpecular * reflectivity) + specular;
